...
$cfg_basehost = '/';
$cfg_cmspath = '';
$cfg_cookie_encode = 'QzJUk6263I';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '首页';
$cfg_webname = '河南省商开智能科技股份有限公司';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 河南省商开智能科技股份有限公司 版权所有&nbsp;&nbsp;<br><br>
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '河南省商开智能科技股份有限公司,商开智能科技';
$cfg_description = '河南省商开智能科技股份有限是一家专业从事高低压开关设备、智能无功补偿电容器、智能配电终端及系统集成设备等；集贸易、技术、服务于一体的系统集成、产品销售、工程服务的高新技术企业。';
$cfg_beian = '   ';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
...
$lianxi = '<p>地址：河南省商丘市睢阳区产业集聚区</p> <p>固话：0370-3250685</p> <p>传真：0370-3250685</p>';
$qqyi = '';
$qqer = '';
$about = '河南省商开智能科技股份有限是一家专业从事高低压开关设备、智能无功补偿电容器、智能配电终端及系统集成设备等；集贸易、技术、服务于一体的系统集成、产品销售、工程服务的高新技术企业。  ';
$en_about = 'Weihe Wire Mesh Products Co., Ltd. is specialized in the production of large enterprises dust bag. Is an advocate of "green" living to the development of environmental technology as the leading industries...';
$en_lianxi = '';
$toubudianhua = '0370-3250685';
?>