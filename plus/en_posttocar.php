...
if($do == 'add')
{
    ...
    */
    ...
    ShowMsg("已添加加到购物车,<a href='cn_car.php'>查看购物车</a>","cn_car.php");
    exit();
}
elseif($do == 'del')
{
    ...
    */
    ...
    ShowMsg("已成功删除购物车中的商品,<a href='cn_car.php'>查看购物车</a>","cn_car.php");
    exit;
}
elseif($do == 'clear')
{
    ...
    */
    $cart->clearItem();
    ShowMsg("购物车中商品已全部清空！","cn_car.php");
    exit;
}
elseif($do == 'update')
{
    ...
    */
    ...
    ShowMsg("购物车中商品已全部更新！","cn_car.php");
    exit;
}