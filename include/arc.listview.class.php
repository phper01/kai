...
class ListView
{
    ...
    else
    {
	 ...
	 return "<li><span class=\"pageinfo\">Total 1 Page/".$this->TotalResult."  Records</span></li>\r\n";
    ...
    else
    {
	 ...
	 return "<li><span class=\"pageinfo\">Total 0 Page/".$this->TotalResult."Records</span></li>\r\n";
